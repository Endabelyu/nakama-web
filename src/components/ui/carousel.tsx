...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    ...
    >
      <span className=''>
        <ArrowLeftIcon className='h-4 w-4 text-listHat' />
      </span>
    </Button>
  );
});
...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  ...
  return (
    ...
    >
      <span>
        <ArrowRightIcon className='h-4 w-4 text-listHat' />
      </span>
      {/* <span className='sr-only bg-listHat'>
        <ArrowRightIcon className='h-4 w-4 bg-listHat' />
      </span> */}
    </Button>
  );
});
